...
def draw(i, j, csv_path, title, end_time):
    ...
    ax1.legend(loc='center left', bbox_to_anchor=(0.5, 0.75), frameon=False, fontsize=fontsize)
    ...
    ax2.legend(["runtime"], loc='center left', bbox_to_anchor=(0.5, 0.65), frameon=False, fontsize=fontsize)
